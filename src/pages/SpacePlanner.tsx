...
export function SpacePlanner() {
  ...
  const saveProposal = async () => {
    if (!selectedItems.length || needsContact) {
      setSaveState('error');
      setSaveError('Completa tu nombre, un WhatsApp de 7 a 15 números y, si lo indicas, un correo con @ y .com.');
      return;
    }
